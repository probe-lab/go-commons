...
var (
	// BootstrapPeersIPFSAmino extracted from:
	...
	BootstrapPeersIPFSAmino = []string{
	...
	// BootstrapPeersFilecoinMainnet extracted from:
	// https://github.com/filecoin-project/lotus/blob/b691adc4874e5e28353f036c077c08ef00ec3b2b/build/bootstrap/mainnet.pi
	// https://github.com/filecoin-project/lotus/blob/master/build/bootstrap/mainnet.pi
	BootstrapPeersFilecoinMainnet = []string{
	...
	// BootstrapPeersFilecoinCalibnet extracted from:
	// https://github.com/filecoin-project/lotus/blob/master/build/bootstrap/calibnet.pi
	BootstrapPeersFilecoinCalibnet = []string{
	...
	//   https://github.com/celestiaorg/celestia-node/blob/1f80fc9e445ad59a2fbd67ffbd0e6e563cb15d47/nodebuilder/p2p/bootstrap.go#L43
	...
	// BootstrapPeersMoneroMainnet extracted from:
	//  https://github.com/monero-project/monero/blob/d0d418483514d3caf79547e302937e45878eab21/src/p2p/net_node.inl#L752
	BootstrapPeersMoneroMainnet = []string{
		"176.9.0.187:18080",
		"88.198.163.90:18080",
		"192.99.8.110:18080",
		"37.187.74.171:18080",
	...
	// BootstrapPeersAlgorandMainnet extracted from: ?
